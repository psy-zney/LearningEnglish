    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="study-panel p-8 w-full max-w-md">
        <div className="flex justify-center mb-6">
          <div className="p-4 bg-[rgba(63,63,59,0.06)] rounded-2xl text-[var(--primary)] ring-1 ring-[var(--primary)]/20">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          {error && (
            <div className="flex items-center gap-2 text-[var(--danger)] text-sm bg-[rgba(166,87,87,0.06)] p-3 rounded-xl border border-[var(--danger)]/20">
